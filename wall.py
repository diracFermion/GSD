...
s = hoomd.init.read_gsd("../Sim_dump_wall/init_strip.gsd")
...
hoomd.analyze.log(filename="../Sim_dump_wall/observable.log", quantities=["temperature", "potential_energy","bond_harmonic_energy","kinetic_energy","dihedral_harmonic_energy"], period=5000, header_prefix="#", overwrite=True)
...
hoomd.dump.gsd(filename="../Sim_dump_wall/trajectory.gsd", group=group.all(), period=5000, overwrite=True,static=[])
