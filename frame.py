...
hoomd.analyze.log(filename="../Sim_dump_frame/observable3.log", quantities=["temperature", "potential_energy","bond_harmonic_energy","kinetic_energy","dihedral_harmonic_energy"], period=5000, header_prefix="#", overwrite=True)
...
hoomd.dump.gsd(filename="../Sim_dump_frame/trajectory3.gsd", group=group.all(), period=5000, overwrite=True,static=[])
